#
#  Be sure to run `pod spec lint KHFlatButton.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Kyle Horn" => "khorn@trunkclub.com", "other author" => "email@address.com" }
  # s.author       = 'Kyle Horn', 'other author'
